...
public class Runner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        usuarios.add(new Usuario("Franco Villanueva", "987654321", "70859665","0","0","{noop}123456"));
        usuarios.add(new Usuario("Karen Gonzales", "985654212", "65985421","0","0","{noop}123456"));
